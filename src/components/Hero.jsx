  ...
  return (
    ...
    >
      <motion.h3
        ...
        className="text-md mdl:text-lg font-titleFont tracking-wide text-textBlue"
      >
        Hi 👋 My name is
      </motion.h3>
      <motion.h1
      ...
      >
        I am an aspiring Software Engineer with a strong background in Data
        Structures and Full Stack Web development. My career interests include
        full-stack development, web designing. <br />
        <a to="about" onClick={() => scrollToSection("about")}>
          <span className="text-textBlue inline-flex relative cursor-pointer h-7 overflow-x-hidden group">
            Learn More
      ...
      <a
        href="https://github.com/DevangKandari"
        target="_blank"
        className="w-52 h-14 text-sm font-titleFont"
      >
        <motion.button
          initial={{ y: 10, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
